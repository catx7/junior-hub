...
import { Eye, EyeOff, Info, Shield, Lock } from 'lucide-react';
  ...
  return (
    <>
            ...
            <div className="space-y-3">
              ...
              <label className="flex items-start gap-2">
                <input
                  ...
                  className="mt-1 h-4 w-4 shrink-0 rounded border-gray-300"
                />
                <span className="text-muted-foreground text-xs">{t('auth.agreeAge')} *</span>
              </label>
              ...
              <label className="flex items-start gap-2">
                <input
                  ...
                  className="mt-1 h-4 w-4 shrink-0 rounded border-gray-300"
                />
                <span className="text-muted-foreground text-xs">{t('auth.agreeMarketing')}</span>
              </label>
            </div>
      ...
      <div className="mt-6 w-full max-w-md text-center">
        <p className="text-muted-foreground text-sm">{t('homepage.trustedByUsers')}</p>
        <div className="text-muted-foreground mt-3 flex justify-center gap-6 text-xs">
          <div className="flex items-center gap-1">
            <Shield className="h-3.5 w-3.5" />
            <span>{t('homepage.verifiedProviders')}</span>
          </div>
          <div className="flex items-center gap-1">
